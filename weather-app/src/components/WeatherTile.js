...
const WeatherTile = ({content}) => {
    return (
        <div className="flex flex-col w-60 h-72 shadow-2xl rounded-xl bg-slate-400 text-center p-5">
            ...
            <div id="bottomstats"className='flex flex-col p-5 gap-2'>
                <div className="flex font-chivo text-sm md:text-md justify-between">
                    <p className='mb-1'>Cloud Coverage:</p>
                    <p>{Math.round(content.clouds)}%</p>
                </div>
                <div className="flex font-chivo text-sm md:text-md justify-between">
